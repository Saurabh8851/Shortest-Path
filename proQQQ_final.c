...
char names[10][15] = {"DELHI", "CHANDIGARH", "JAIPUR", "SHIMLA", "DEHRADUN", "", "", "", "", ""};
int cities = 5;
...
{
    addEdge(graph, 0, 1, 245);
    addEdge(graph, 0, 2, 280);
    addEdge(graph, 0, 3, 345);
    addEdge(graph, 1, 2, 517);
    addEdge(graph, 1, 3, 113);
    addEdge(graph, 2, 3, 610);
    addEdge(graph, 4, 1, 170);
    addEdge(graph, 4, 2, 525);
    addEdge(graph, 4, 3, 230);
}
...
int main()
{
    ...
    char title[] = "SHORTEST DISTANCE CALCULATOR.................by SAURABH";
    printf("\n\n");
